...
def setQos(ifaces):
    for iface in ifaces:
        ...
        --id=@q3 create queue other-config:priority=2 other-config:min-rate=10000 other-config:max-rate=95000 -- \
        --id=@q4 create queue other-config:priority=1 other-config:max-rate=1000000000' % iface)
