#Ref: https://github.com/ChargePoint/pydnp3/blob/master/examples/master.py
import logging
import sys
import time
...
class Master:
    ...
    """
    def __init__(self, log_levels, local_ip, port, host_ip, log_handler=asiodnp3.ConsoleLogger().Create(),
                 listener=asiodnp3.PrintingChannelListener().Create(),
                 soe_handler=asiodnp3.PrintingSOEHandler().Create(),
                 master_application=asiodnp3.DefaultMasterApplication().Create(), stack_config = None):
